...
import 'package:charitree/drawer.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: MyHomePage(title: 'MasterCares'),
    );
  }
}
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void handleLink(Uri link) {
    ...
    Navigator.push(
          context, MaterialPageRoute(builder: (context) => MovieDetailsPage(testMovie)));
    if (parameters[0] == "inbox" && parameters[1] != null) {
      Navigator.push(
          context, MaterialPageRoute(builder: (context) => CharityPage()));
    }
  }
}
